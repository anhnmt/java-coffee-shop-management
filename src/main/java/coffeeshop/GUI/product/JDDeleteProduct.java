...
public class JDDeleteProduct extends javax.swing.JDialog {
     ...
     */
    public JDDeleteProduct(java.awt.Frame parent, boolean modal, CallbackDelete callback, Product product) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDDeleteProduct dialog = new JDDeleteProduct(new javax.swing.JFrame(), true, null, null);
